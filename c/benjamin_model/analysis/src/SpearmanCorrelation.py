# PearsonSpearman.py
#
# Compute the Spearman correlation coefficient of two arrays
#
...
array1 = [0.0 for i in xrange(size)] #scipy.zeros(size)
array2 = [0.0 for i in xrange(size)] #scipy.zeros(size)
